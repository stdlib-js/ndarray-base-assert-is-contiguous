...
```javascript
isContiguous = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-contiguous@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-contiguous@umd/bundle.js"></script>
```
